...
class PolicySubjectModel(Base):
    ...
    __tablename__ = 'dabac_policy_subjects'

    id = Column(Integer, primary_key=True)
    uid = Column(String(255), ForeignKey('dabac_policies.uid', ondelete='CASCADE'))
...
class PolicyResourceModel(Base):
    ...
    __tablename__ = 'dabac_policy_resources'
...
class PolicyActionModel(Base):
    ...
    __tablename__ = 'dabac_policy_actions'
